...
public class Baseclass {
		...
		public static void wait(int Min) {
			Server.driver.manage().timeouts().implicitlyWait(Duration.ofMinutes(Min));
		}
		...
		public static void screenshot(String name) throws IOException {
			...
			File des=new File("\\src\\reports\\cucumber-reports\\screenshots\\Fail"+name+".png");
		...
		public static void MovetoElemt(Object name ) {
			Actions b=new Actions(Server.driver);
			b.moveToElement((WebElement) name).build().perform();
				
		}
		public static void MoveToClick(Object name) {
			Actions a= new Actions(Server.driver);
			a.moveToElement((WebElement) name).click().build().perform();
		}
		public static void draganddrop( Object source ,Object target) {
			Actions a=new Actions(driver);
			a.dragAndDrop((WebElement)source,(WebElement) target).build().perform();
		...
		public static void findxpath(String location) {
			Server.driver.findElement(By.name(location));
		...
		public static void toclick(WebElement args) {
			JavascriptExecutor j=(JavascriptExecutor)Server.driver;
...
//			actions.sendKeys("R");
		...
		public static void Multiple_job(int c) {
	...
	public static void past () throws Throwable {
	...
	public static String getsomeFutureDate() {
	...
	public static void Calendar() {
		System.out.println(getsomeFutureDate());
		
	}
	
	/*public static void AlertPopup() throws Throwable {
		
		Thread.sleep(3000);
		System.out.println(SCM_WOA_Coding.Head.getText());
		Thread.sleep(3000);
		System.out.println(SCM_WOA_Coding.Body.getText());
		Thread.sleep(2000);
		SCM_WOA_Coding.Ok.click();
		
	}*/
	public static void ToRight(WebElement a) {
		
		JavascriptExecutor js = (JavascriptExecutor)Server.driver; 
		js.executeScript("arguments[0].scrollIntoView();",a);
	}
	
	public static void Windownshand() throws Throwable {
		
		Set<String> window = Server.driver.getWindowHandles();
		System.out.println("Windowns ID : "+window);
		List<String> List = new ArrayList<String>(window);
		Thread.sleep(3000);
		System.out.println("Windowns ID : "+List.get(1));
		Server.driver.switchTo().window(List.get(1));		
	}
	
	public static void Android_Scroll_Buttom(String visibleText) {
		
		Server.driver.findElement(new AppiumBy.ByAndroidUIAutomator("new UiScrollable(new UiSelector().scrollable(true).instance(0)).scrollIntoView(new UiSelector().descriptionContains(\""+visibleText+"\").instance(0))"));
	     
	    }
	
	public static void Android_Movetoclick () {
		
		
		
		
//		TouchAction swipe = new TouchAction(driver);
//		AndroidTouchAction Action = new AndroidTouchAction(Server.driver);
//		Action.press(ObjectsReporsitory.Approve).perform();
//		TouchAction action = new TouchAction(driver);
//		action.scroll(element, 10, 100);
//		action.perform();
//		element.click();
//		
//		MobileOptions mbAct = new MobileOptions(driver);
		
//		deviceSize = Server.driver.get_window_size();
//		System.out.println("Device Width and Height :" +deviceSize);
