...
Feature: EIP40 Techno Commercial Document (TCD) Mobile Application
  
  UserStory: EIP40 Mobile Application Supply Chain Management
  
  Description :User i should be able to EIP40 Mobile App

  Scenario: User i should be able to Login Approved Techno Commercial Document (TCD) from EIP40 Mobile App
    ...
    And Verify user can able to select TCD Document
  ...
  Scenario: User i should be able to Login Reject Techno Commercial Document (TCD) from EIP40 Mobile App
    Given Verify user can be able to Login EIPMobile Application
    When Verify user can be able to click on Work Bench EIP40Mobile
    And Verify user can able to click on SCM
    And Verify user can able to select TCD Document
  ...
  Scenario: User i should be able to Login Hold Techno Commercial Document (TCD) from EIP40 Mobile App
    Given Verify user can be able to Login EIPMobile Application
    When Verify user can be able to click on Work Bench EIP40Mobile
    And Verify user can able to click on SCM
    And Verify user can able to select TCD Document
    And Verify user can able to select to Document
    And Verify user can able to Hold to TCD Document
    And Verify user can able to Handle Alert Message from Hold
    Then Verify user can be able to Logout to EIP Mobile Application
@TCD
  Scenario: User i should be able to Login Hold document Appprove Techno Commercial Document (TCD) from EIP40 Mobile App
    Given Verify user can be able to Login EIPMobile Application
    When Verify user can be able to click on Work Bench EIP40Mobile
    And Verify user can able to click on SCM
    And Verify user can able to select TCD Document
  ...
  Scenario: User i should be able to Login Document View Techno Commercial Document (TCD) from EIP40 Mobile App
  ...
  Scenario: User i should be able to Login Document Attachment View Techno Commercial Document (TCD) from EIP40 Mobile App
    Given Verify user can be able to Login EIPMobile Application
    When Verify user can be able to click on Work Bench EIP40Mobile
    And Verify user can able to click on SCM
    And Verify user can able to select TCD Document
  ...
  Scenario: User i should be able to Login Work Flow Trace Techno Commercial Document (TCD) from EIP40 Mobile App
