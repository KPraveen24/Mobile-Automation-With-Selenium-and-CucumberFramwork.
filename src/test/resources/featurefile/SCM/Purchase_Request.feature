...
Feature: EIP40 Purchase Request Mobile Application 
  
  UserStory: EIP40 Mobile Application Supply Chain Management
 
  Description : As a EIP User i should be able to EIP40 Mobile App

	Scenario: As a EIP User i should be able to Login Hold Purchase Request (PR) from EIP40 Mobile App
    ...
    And Verify user can able to select PR Document
 ...
 Scenario: As a EIP User i should be able to Login Hold document Approve Purchase Request (PR) from EIP40 Mobile App
    ...
    Then Verify user can be able to Logout to EIP Mobile Application 
 	...
 	Scenario: As a EIP User i should be able to Login Approve Purchase Request (PR) from EIP40 Mobile App
  ...
  Scenario: As a EIP User i should be able to Login Reject Purchase Request (PR) from EIP40 Mobile App
  ...
  Scenario: As a EIP User i should be able to Login Document View Purchase Request (PR) from EIP40 Mobile App
  ...
  Scenario: As a EIP User i should be able to Login Document Attachment View Purchase Request (PR) from EIP40 Mobile App
  ...
  Scenario: As a EIP User i should be able to Login Work Flow Trace Purchase Request (PR) from EIP40 Mobile App
    ...
    And Verify user can able to get listout flow from PR
    Then Verify user can be able to Logout to EIP Mobile Application
